...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= base_url('/custom/loginstyle.css')?>">
        ...
        <div class="row justify-content-md-center mb-5">
            <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6">
                <div class="bg-white p-4 p-md-5 rounded shadow-lg">
                    ...
                    <form action="<?= site_url('authcontroller/valid_login') ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center">
                                <p>Belum mempunyai akun? <span><a href="/pictogallery/auth/register" class="link-secondary text-decoration-none text-primary">Register</a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
